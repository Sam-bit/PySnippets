...
income_statement_url = 'https://finance.yahoo.com/quote/' + company_ticker + '/financials'

driver = webdriver.Chrome(CHROME_DVR_DIR)
driver.get(income_statement_url)
htmlSource = driver.page_source
#income_statement_html = requests.get(income_statement_url)
income_statement_soup = bs(htmlSource, 'html.parser')
...
balance_sheet_url = 'https://finance.yahoo.com/quote/' + company_ticker + '/balance-sheet'
driver.get(balance_sheet_url)
htmlSource = driver.page_source
#balance_sheet_html = requests.get(balance_sheet_url)
balance_sheet_soup = bs(htmlSource, 'html.parser')
...
driver.get(market_cap_url)
htmlSource = driver.page_source
market_cap_soup = bs(htmlSource, 'html.parser')
